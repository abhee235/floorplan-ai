...
export function architectSystem(): string {
  return join([
    ...
    section("# How to go about it", [
      ...
      "3a. Say how many people every room holds, in capacity, and work its area out from that rather than picking a number. An open office is 8 to 10 m² a person, a meeting room 1.8 to 2.3, a boardroom 2.5 to 3, a cafeteria 1.3. A hundred people need 800 to 1000 m² of open office and the checker will refuse less, so a brief for a hundred people is a building of well over a thousand square metres before anything else is in it.",
